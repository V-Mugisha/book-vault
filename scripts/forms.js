// Storage functionality
        ...
        const validators = {
            isbn: (value) => {
                ...
                return {
                    isValid: false,
                    error: 'Invalid ISBN format. Use ISBN-10 (10 digits) or ISBN-13 (13 digits starting with 978 or 979)'
                };
            },
        ...
        const initForm = () => {
            ...
            if (editId) {
                ...
                document.getElementById('pageDescription').textContent = 'Update book information';
        ...
        const validateForm = () => {
            ...
            // Genre validation
            const genreValidation = validators.required(genreInput.value);
